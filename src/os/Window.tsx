...
function iconGlyph(name: string): React.ReactNode {
  ...
  if (name === 'iaeks') return <IaeksGlyph />
...
function IaeksGlyph() {
  return (
    <svg viewBox="0 0 34 34" width="1em" height="1em" style={{ display: 'inline-block', verticalAlign: 'middle' }} aria-hidden focusable="false">
      <defs>
        <linearGradient id="iaeks-grad" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#0ea5e9" />
          <stop offset="100%" stopColor="#7c3aed" />
        </linearGradient>
      </defs>
      <rect width="34" height="34" rx="7" fill="url(#iaeks-grad)" />
      <text x="17" y="22" textAnchor="middle" fontFamily="system-ui, sans-serif" fontWeight="700" fontSize="12" fill="#fff">IA</text>
      <circle cx="27" cy="8" r="3" fill="#fbbf24" />
    </svg>
  )
}
